/*
 * RTSP pull -> RKMPP H264/H265 decode -> DRM display
 *
 * Pipeline:
 *   RTSPPullerNode --[Packet]--> RKMPPDecoderNode --[DecodedFrame]--> DRMDisplayNode
 *
 * Usage:
 *   ./rtsp_pull_decode_display [rtsp_url] [codec] [drm_device]
...
int main(int argc, char **argv)
{
    std::cout << "RTSP Pull -> RKMPP Decode -> DRM Display\n"
              << "\n"
              << "Usage: rtsp_pull_decode_display [rtsp_url] [codec] [drm_device]\n"
              << "\n"
              << "Arguments:\n"
